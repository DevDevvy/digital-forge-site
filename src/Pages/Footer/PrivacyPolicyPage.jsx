  ...
  return (
    <div id="policyContainer">
      ...
      <ul>
        ...
        <li>
          How do we process your information? <a href="#section4">Learn more</a>
        </li>
        <li>
      ...
      <p className="policyParagraph">
        ...
        information. Ensuring the accuracy of your information is vital for
        effective communication and to maintain the security of your account.
      </p>
      ...
      <ul>
        <li>To provide personalized services tailored to your preferences.</li>
        <li>
      ...
      <p className="policyParagraph">
        We have implemented safeguards to protect your personal information when
        shared with third parties, including contractual obligations and data
