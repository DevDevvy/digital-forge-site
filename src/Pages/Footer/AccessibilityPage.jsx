    ...
    <>
      ...
      <div id="policyContainer">
        ...
        <p className="policyParagraph">
          ...
          <ul>
            <li>
              <em>Text Alternatives:</em> Images have alternative text that can
        ...
        <p className="policyParagraph">
          If you need any assistance while visiting our website, or if you
          require any information in an alternative format, please contact us.
        </p>
        <h4 className="privacyPolicySummaryOfKeyPoints">
