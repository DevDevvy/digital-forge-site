      ...
      <body className="page-container">
        ...
        <header className="page-header">
          ...
          <p>
            ...
            solutions that meet your specific business needs. From advanced web
            applications to intuitive mobile apps, our expertise is your gateway
            to a digitally transformed future.
          </p>
        </header>
